...
RSpec.describe RuboCop::Cop::LightServices::MissingPrivateKeyword, :config do
    ...
    it "registers an offense for public step method" do
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          ...
          def process
          ^^^^^^^^^^^ LightServices/MissingPrivateKeyword: Step method `process` should be private.
            # implementation
          end
        end
      RUBY
    ...
    it "registers offenses for multiple public step methods" do
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          ...
          def validate
          ^^^^^^^^^^^^ LightServices/MissingPrivateKeyword: Step method `validate` should be private.
            # implementation
          end
