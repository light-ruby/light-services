...
RSpec.describe RuboCop::Cop::LightServices::ConditionMethodExists, :config do
      ...
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          step :process, if: :should_process?
                             ^^^^^^^^^^^^^^^^ LightServices/ConditionMethodExists: Condition method `should_process?` has no corresponding method. For inherited methods, disable this line or add to ExcludedMethods.
      ...
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          step :notify, unless: :skip_notification?
                                ^^^^^^^^^^^^^^^^^^^ LightServices/ConditionMethodExists: Condition method `skip_notification?` has no corresponding method. For inherited methods, disable this line or add to ExcludedMethods.
      ...
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          ...
          step :notify, unless: :skip?
                                ^^^^^^ LightServices/ConditionMethodExists: Condition method `skip?` has no corresponding method. For inherited methods, disable this line or add to ExcludedMethods.
    ...
    it "registers an offense when condition does not match any arg" do
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          ...
          step :process, if: :enabled?
                             ^^^^^^^^^ LightServices/ConditionMethodExists: Condition method `enabled?` has no corresponding method. For inherited methods, disable this line or add to ExcludedMethods.
