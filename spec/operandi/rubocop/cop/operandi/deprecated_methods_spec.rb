...
RSpec.describe RuboCop::Cop::Operandi::DeprecatedMethods, :config do
      ...
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          ...
          def process
            ...
            ^^^^^ Operandi/DeprecatedMethods: Use `stop!` instead of deprecated `done!`.
          end
        end
      RUBY
    end
    ...
    it "registers an offense for done?" do
      expect_offense(<<~RUBY)
        class MyService < ApplicationService
          ...
          def process
            return if done?
                      ^^^^^ Operandi/DeprecatedMethods: Use `stopped?` instead of deprecated `done?`.
          end
        end
      RUBY
    end
